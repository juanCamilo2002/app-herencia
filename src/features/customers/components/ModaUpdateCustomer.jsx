...
const ModaUpdateCustomer = ({open, onClose, customer}) => {
  return (
          ...
          <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
            ...
            <div className="mt-2">
              <p className="text-sm dark:text-gray">
                Llena los campos para editar cliente.
              </p>
            </div>
          </div>
        </div>
      </div>
      <FormCustomer onClose={onClose} initialValues={customer} />
    </ModalContainer>
  )
}

export default ModaUpdateCustomer